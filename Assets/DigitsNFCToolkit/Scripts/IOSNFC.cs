...
namespace DigitsNFCToolkit
{
	...
	public class IOSNFC: NativeNFC
	{
		...
		[DllImport("__Internal")]
		private static extern void _nativeNFC_setReadAlertMessage(string alertMessage);
		[DllImport("__Internal")]
		private static extern void _nativeNFC_setWriteAlertMessage(string alertMessage);
		...
		public override bool IsNDEFPushSupported()
		{
			return false;
		}
		...
		public override void SetReadAlertMessage(string alertMessage)
		{
			_nativeNFC_setReadAlertMessage(alertMessage);
		}

		public override void SetWriteAlertMessage(string alertMessage)
		{
			_nativeNFC_setWriteAlertMessage(alertMessage);
		}
	}
}
#endif