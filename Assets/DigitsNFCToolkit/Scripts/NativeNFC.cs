...
namespace DigitsNFCToolkit
{
	...
	public abstract class NativeNFC: MonoBehaviour
	{
		...
		public abstract bool IsNDEFPushSupported();
		...
		/// <summary>Sets the alert message when doing a read operation</summary>
		public abstract void SetReadAlertMessage(string alertMessage);

		/// <summary>Sets the alert message when doing a write operation</summary>
		public abstract void SetWriteAlertMessage(string alertMessage);
